...
import researchIcon from "@/public/services/research_1.png";
import strateqyIcon from "@/public/services/strategy_1.png";
import data from "@/public/services/data_1.png";
import analytics from "@/public/services/analytics_1.png";
import data_analytics from "@/public/services/data_analytics_1.png";
            ...
            <div key={step.id} className={styles.stepCard}>
              <div className={styles.blog_info}>
                <div className={styles.icon_blog}>
                  {step.icon && (
                    <Image src={step.icon} alt={"dd"} className={styles.icon} />
                  )}
                </div>
